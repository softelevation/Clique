...
export default class AddJob extends Component {
    ...
    API_ADD_COMPANY(isload){
        ...
        Webservice.post(APIURL.companyAdd, {
            ...
            logo : this.state.ProfileImgData != null ? this.state.ProfileImgData.base64 : '',
            ...
            number : this.state.txtMobileNo != '' ? this.state.countryCode+"-"+this.state.txtMobileNo : '',
                    ...
                    <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
                        ...
                        <View style={styles.headerView}>
                            ...
                            <TouchableOpacity style={{ marginRight: 15, alignItems: 'center', justifyContent: 'center', height: 40, width: 40, }}
                                ...
                                <Image style={{ width: 20, height: 20, resizeMode: 'contain', tintColor: CommonColors.arrowColor }}
                                    source={TickIcon} />
                            </TouchableOpacity>
                        </View>
                        ...
                        <ScrollView style={{ flex: 1, }}>
                            ...
                            <View style={{
                                ...
                                <FastImage style={{ width: 150, height: 150, borderRadius: 75 }}
                                    source={ this.state.ProfileImgData != null ? { uri: this.state.ProfileImgData.uri } : { uri: 'https://i.stack.imgur.com/y9DpT.jpg' } }
                            ...
                            <TextInput
                                ...
                                style={{
                                    ...
                                    backgroundColor : CommonColors.appBarColor, borderRadius : 10, marginTop:10, paddingLeft : 10, paddingRight : 10
                                }}
                                value={this.state.txtCompanyName}
                                returnKeyType={'done'}
                                onChangeText={async (txtCompanyName) => {
                                    await this.setState({ txtCompanyName: txtCompanyName.replace(/[^a-z,^A-Z,^\s]/g, '') })
                            ...
                            <TextInput
                                ...
                                multiline={true}
                                style={{
                                    marginLeft: 20, marginRight: 20, flex: 1, marginTop: 5, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, fontFamily: ConstantKeys.Averta_REGULAR,
                                    padding : 10, minHeight: 100, backgroundColor: CommonColors.appBarColor, borderRadius : 10, marginTop:10
                                }}
                            ...
                            <TextInput
                                ...
                                onChangeText={async (txtJobPosition) => {
                                    await this.setState({ txtJobPosition: txtJobPosition.replace(/[^a-z,^A-Z,^\s]/g, '') })
                            ...
                            <View style={{
                                ...
                                marginLeft:20, marginRight: 20, marginTop:10, height: 50,
                                backgroundColor: CommonColors.appBarColor, flexDirection: 'row'
                            }}>
                            ...
                            <View style={{
                                height: 50, alignItems: 'center', flexDirection: 'row', flex: 1, marginRight: 20, marginLeft:20,
                               borderRadius: 10, marginTop:5, backgroundColor: CommonColors.appBarColor
                            }}>
                            ...
                            <View style={{
                                height: 50, alignItems: 'center', flexDirection: 'row', flex: 1, marginRight: 20, marginLeft:20,
                               borderRadius: 15, marginTop:5, backgroundColor: CommonColors.appBarColor
                            }}>
                            ...
                            <View style={{
                                height: 50, alignItems: 'center', flexDirection: 'row', flex: 1, marginRight: 20, marginLeft:20, marginBottom:20,
                               borderRadius: 10, marginTop:5, backgroundColor: CommonColors.appBarColor
                            }}>

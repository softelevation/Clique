...
import { View, Text, SafeAreaView, StyleSheet, StatusBar, TouchableOpacity, Image, FlatList, Alert, PermissionsAndroid, ScrollView, Linking } from 'react-native';
...
export default class JobDetail extends Component {
    ...
    OpenTwitter = (item) => {
        requestAnimationFrame(() => {
            Linking.openURL('twitter://user?screen_name=' + item)
                  .catch(() => {
                        ...
                        <ScrollView style={{ flex: 1, }}>
                            ...
                            <View style={{ width: '100%', height: 250 }}>
                                ...
                                {this.state.userData != null ?
                                    <Image source={{ uri: String(this.state.userData.asset_url + this.state.JobData.logo) }}
                                        style={{ flex: 1 }}
                                        resizeMode={FastImage.resizeMode.cover}
                                    />
                                    : null}

                                <View style={{ position: 'absolute', backgroundColor: CommonColors.transprentDark, bottom: 0, width: '100%', flexDirection: 'row' }}>

                                    <Image source={{ uri: String(this.state.userData.asset_url + this.state.user.avatar) }}
                                        style={{ height: 60, width: 60, borderRadius: 30, marginLeft: 20, marginTop: 10, marginBottom: 10 }}

                                    />
                                    <View style={{ flex: 1 }}>
                                        <Text style={{
                                            marginLeft: 10, marginRight: 20, textAlign: 'left', marginTop: 15, fontSize: SetFontSize.ts25,
                                        ...
                                        <Text style={{
                                            marginLeft: 10, marginRight: 20, textAlign: 'left', marginTop: 5, fontSize: SetFontSize.ts14,
                                            color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR, marginBottom: 10
                                        }}>
                                            {this.state.JobData.job_position} at {this.state.JobData.name}
                                        </Text>
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={{
                                ...
                                <View style={{ padding: 10, marginTop: 15, minHeight: 50, backgroundColor: CommonColors.appBarColor, borderRadius: 10, justifyContent: 'center' }}>
                                    <Text style={{ fontSize: SetFontSize.ts14, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                            ...
                            <View style={{
                                ...
                                <View style={{ height: 50, alignItems: 'center', flexDirection: 'row', marginTop: 15, backgroundColor: CommonColors.appBarColor, borderRadius: 10, }}>

                                    <Image style={{ height: 30, width: 30, borderRadius: 15, marginLeft: 10, resizeMode: 'contain' }}
                                        source={WorkIcon} />

                                    <Text style={{ flex: 1, marginLeft: 10, marginRight: 10, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                            ...
                            <View style={{
                                marginTop: 15, marginBottom: 20, marginLeft: 20, marginRight: 20, borderRadius: 15,
                            }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15, marginLeft: 15, marginRight: 15 }}>
                                ...
                                {this.state.JobData.number != null ?
                                    <TouchableOpacity style={{
                                        height: 50, alignItems: 'center', flexDirection: 'row', marginTop: 15, backgroundColor: CommonColors.appBarColor,
                                        borderRadius: 10
                                    }}
                                        onPress={() => this.OpenCall(this.state.JobData.number)}
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.number)}>
                                ...
                                {this.state.JobData.website != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.website)}>
                                ...
                                {this.state.JobData.email != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.email)}>
                                ...
                                {this.state.JobData.facebook != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onPress={() => this.OpenFaceBook(this.state.JobData.facebook)}
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.facebook)}>
                                ...
                                {this.state.JobData.instagram != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onPress={() => this.OpenInstagram(this.state.JobData.instagram)}
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.instagram)}>
                                ...
                                {this.state.JobData.linkedin != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onPress={() => this.OpenLinkdin(this.state.JobData.linkedin)}
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.linkedin)}>
                                ...
                                {this.state.JobData.twitter != null ?
                                    <TouchableOpacity style={{
                                        ...
                                        onLongPress={() => this.CopyTextToClipBoard(this.state.JobData.twitter)}>

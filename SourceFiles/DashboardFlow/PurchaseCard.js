...
import {
    View, Text, SafeAreaView, StyleSheet, StatusBar, TouchableOpacity, Image, FlatList, TextInput,Dimensions,
    Platform, Alert, PermissionsAndroid, ScrollView
} from 'react-native';
    ...
    getData = async () => {
        try {
            ...
            if (value !== null) {
                ...
                this.setState({ userData: userData, user: userData.user , txtFullName : user.name, txtEmail : user.email, txtMobileNo : Fullmobile[1], countryCode : Fullmobile[0]})
        ...
        Webservice.post(APIURL.putOrder,{
            ...
            .then(response => {
                ...
                if (response.data.status == true) {
                    ...
                    Alert.alert(ValidationMsg.AppName,response.data.message,[
                        {
                        text: 'OK',
                        onPress: () => {
                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
                        ...
                        <ScrollView style={{ flex: 1, }}>
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TextInput
                                    ...
                                    style={{
                                        marginLeft: 20, marginRight: 20,marginTop:10, flex: 1, height: 50, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, 
                                            fontFamily: ConstantKeys.Averta_REGULAR, backgroundColor : CommonColors.appBarColor, borderRadius :10, paddingLeft:10, paddingRight:10
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TextInput
                                    ...
                                    style={{
                                        marginLeft: 20, marginRight: 20,marginTop:10, flex: 1, height: 50, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, fontFamily: ConstantKeys.Averta_REGULAR,
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 10, marginLeft: 20, marginRight: 20, height: 50, backgroundColor: CommonColors.appBarColor, borderRadius: 10 }}>
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TextInput
                                    ...
                                    style={{
                                        ...
                                        paddingLeft:10,paddingRight : 10, backgroundColor: CommonColors.appBarColor, marginTop:10, borderRadius :10
                                    }}
                                    value={this.state.txtQuantity}
                                    returnKeyType={'done'}
                                    onChangeText={async (txtQuantity) => {
                                        await this.setState({ txtQuantity: txtQuantity.replace(/[^0-9]/g, '') })
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TextInput
                                    ...
                                    multiline={true}
                                    style={{
                                        marginLeft: 20, marginRight: 20, flex: 1, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, fontFamily: ConstantKeys.Averta_REGULAR,
                                        minHeight: 100, padding: 10, backgroundColor: CommonColors.appBarColor, marginTop : 10, borderRadius : 10
                                    }}
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TouchableOpacity style={{
                                    marginLeft: 20, marginRight: 20, flex:1, alignItems:'center', height: 50, backgroundColor: CommonColors.appBarColor, fontSize: SetFontSize.ts16, 
                                    fontFamily: ConstantKeys.Averta_REGULAR, flexDirection:'row', marginTop:10, borderRadius:10
                                }}
                                onPress={() => this.RBSheet.open()}>
                                <Text style={{marginLeft:10, marginRight:5, flex:1, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, fontFamily: ConstantKeys.Averta_REGULAR, }}>
                                        {this.state.selectedCountry.name}
                                </Text>

                                <Image source={DownArrowIcon}
                                    style={{height:10,width:10, resizeMode:'contain',marginRight:10, tintColor : CommonColors.whiteColor }}
                                />
                            </TouchableOpacity>
                            ...
                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={async (txtState) => {
                                        await this.setState({ txtState: txtState.replace(/[^a-z,^A-Z,^\s]/g, '') })

                                    }}
                                />
                            

                            <Text style={{marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: SetFontSize.ts16, color: CommonColors.whiteColor,
                                ...
                                <TextInput
                                    ...
                                    placeholderTextColor={CommonColors.whiteColor}
                                    style={{
                                        marginLeft: 20, marginRight: 20, marginBottom:20, flex: 1, height: 50, color: CommonColors.whiteColor, fontSize: SetFontSize.ts16, fontFamily: ConstantKeys.Averta_REGULAR,
                                        paddingLeft:10,paddingRight : 10, backgroundColor: CommonColors.appBarColor, marginTop:10, borderRadius :10
                                    }}
                                    value={this.state.txtZipCode}
                                    onChangeText={async (txtZipCode) => {
                                        await this.setState({ txtZipCode: txtZipCode.replace(/[^0-9]/g, '') })
                        ...
                        <LinearGradient colors={[CommonColors.gradientStart, CommonColors.gradientEnd]}
                          ...
                          style={{
                                height: 50, marginBottom: 20, marginLeft: 20,marginTop: 5, marginRight: 20, alignItems: 'center', justifyContent: 'center', borderRadius: 10, 
                            }}>
                        ...
                        <RBSheet
                                ...
                                <View style={{ flex: 1, width:'100%', backgroundColor: CommonColors.whiteColor }}>
                                    ...
                                    <FlatList style={{ marginTop: 5, }}
                                        ...
                                        renderItem={({ item }) => (
                                            ...
                                            <TouchableOpacity style={{marginLeft:20,marginRight:20,height:50, borderBottomColor : CommonColors.inActiveColor, borderBottomWidth : 1}}
                                                onPress={() => this.selectCountry(item)}>
                                                <View style={{ flex: 1, justifyContent: 'center' }}>
                                                    <Text style={{fontSize: SetFontSize.ts16, color: CommonColors.MortarColor, fontFamily: ConstantKeys.Averta_REGULAR}}>
                                                        {item.name}
                                                    </Text>
...
const styles = StyleSheet.create({
    ...
    viewClique: {
        backgroundColor: CommonColors.PurpleColor, flexDirection: 'row', alignItems:'center', marginBottom:20
    },
    headerView: {
    ...
    headerText: {
        ...
        color: CommonColors.whiteColor, textAlign: 'center', flex:1
    },
    viewCountrystyle: {
        flexDirection: 'row',
        height: 50,
    ...
    btnPurchase: {
        marginLeft: 20, marginRight: 20, marginTop: 30,marginBottom:20, height: 50, backgroundColor: CommonColors.PurpleColor,

...
import {
  View, Text, SafeAreaView, StyleSheet, StatusBar, TouchableOpacity, Image, Dimensions, Platform,
  ...
  _onTagDiscovered = tag => {
    ...
    if (url) {
      ...
      if (params.userid == this.state.user.user_id) {
        ...
        this.props.navigation.navigate('UserProfile', { profile_id: params.userid })
      }
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
            ...
            <View style={{ flex: 1, }}>
              ...
              <Text style={{
                marginLeft: 20, marginTop: 20, marginRight: 20, marginBottom : 20, fontSize: SetFontSize.ts25, fontFamily: ConstantKeys.Averta_BOLD,

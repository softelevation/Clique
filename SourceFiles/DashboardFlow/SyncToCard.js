...
import NfcManager, { NfcEvents, NfcAdapter, NfcTech, Ndef } from 'react-native-nfc-manager';
                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
                        ...
                        <View style={{ flex: 1,  }}>
                                ...
                                <Video source={require('../Assets/Images/Video/scanVideo.mp4')}   // Can be a URL or a local file.
                                    ref={(ref) => {
                                        this.player = ref
                                    }} 
                                    resizeMode={'contain'}
                                    ...
                                    <Text style={{marginLeft:20, marginTop:20, marginRight:20, marginBottom : 20, fontSize: SetFontSize.ts25, fontFamily: ConstantKeys.Averta_BOLD, 

...
export default class UserProfile extends Component {
  ...
  getData = async () => {
    try {
      ...
      if (value !== null) {
        ...
        await this.setState({ userData: userData, user: userData.user, is_temp: userData.user.is_temp })
  ...
  btnAddContactTap = () => {
    requestAnimationFrame(() => {
      ...
      Alert.alert(ValidationMsg.AppName, "Are you sure you add this contact?", [
        {
          text: 'Yes',
          onPress: () => {
          ...
          <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
            ...
            <View style={{ flex: 1 }}>
              {this.state.profileData != null ?
                ...
                <View style={{ flex: 1, backgroundColor: CommonColors.PurpleColor, }}>

                  <ScrollView style={{ flex: 1, backgroundColor: CommonColors.primaryColor, }} bounces={false}>
                        ...
                        <View style={{ marginTop: 5, }}>
                          <FlatList data={this.state.CompanyData}
                            ...
                            renderItem={({ item, index }) => (
                              ...
                              (item.job_position != '' ?
                                <TouchableOpacity style={{
                                  height: 60, alignItems: 'center', flexDirection: 'row', backgroundColor: CommonColors.appBarColor,
                                  borderRadius: 10, paddingLeft: 10, paddingRight: 10, marginTop: 10
                                }}
                                  ...
                                  <View style={{ flex: 1, justifyContent: 'center' }}>
                                    ...
                                    <Text style={{ marginTop: 5, marginLeft: 10, fontSize: SetFontSize.ts14, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_REGULAR }}
                                      numberOfLines={1}>
                                      {item.name}
                                    </Text>
                                  </View>
                    ...
                    {this.state.SocialData.length != 0 ?
                      <View style={{
                        marginTop: 20, marginLeft: 20, marginRight: 20, borderRadius: 15,
                      }}>
                    ...
                    {this.state.MusicData.length != 0 ?
                      <View style={{
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15, marginLeft: 15, marginRight: 15 }}>
                          ...
                          <Text style={{ marginLeft: 10, fontSize: SetFontSize.ts14, color: CommonColors.whiteColor, fontFamily: ConstantKeys.Averta_BOLD }}>
                            Music
                        </Text>
                        </View>
                          ...
                          <FlatList data={this.state.MusicData}
                            ...
                            renderItem={({ item, index }) => (
                              ...
                              (item.media_value != '' ?
                                <TouchableOpacity style={{
                                  height: 50, alignItems: 'center', flexDirection: 'row', backgroundColor: CommonColors.appBarColor,
                                  marginTop: 10, paddingLeft: 10, paddingRight: 10, borderRadius: 10
                                }}
                          ...
                          <FlatList data={this.state.ExternalLinkData}
                            ...
                            renderItem={({ item, index }) => (
                              ...
                              (item.media_value != '' ?
                                <TouchableOpacity style={{
                                  height: 50, alignItems: 'center', flexDirection: 'row', backgroundColor: CommonColors.appBarColor,
                                  marginTop: 10, borderRadius: 10, paddingRight: 10, paddingLeft: 10,
                                }}
                  ...
                  <View style={{ height: 50, }}>
                    {this.state.isContact == 1 ?
                      <TouchableOpacity style={{
                        height: 50, backgroundColor: CommonColors.errorColor, alignItems: 'center', justifyContent: 'center'
                      }}
                      ...
                      <TouchableOpacity style={{
                        height: 50, backgroundColor: CommonColors.arrowColor, alignItems: 'center', justifyContent: 'center'
                      }}

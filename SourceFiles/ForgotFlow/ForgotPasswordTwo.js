            ...
            <SafeAreaView style={{ flex: 1 }}>
                <ImageBackground source={images.forgotBg} style={styles.container}>
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }} bounces={false}>
                        ...
                        />
                        <Block backgroundColor={'#FDFFFF'} borderTopRightRadius={30} borderTopLeftRadius={30} middle padding={[0, wp(3)]}>
                            ...
                            <Image style={{ alignSelf: 'center',  height: hp(40), width:  wp(80), resizeMode: 'contain' }}
                            ...
                            <Text style={styles.txtAlreadyAccount} onPress={() => this.setNewPwdClick()}>
                                Set a new password
                            </Text>

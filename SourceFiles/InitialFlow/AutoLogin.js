...
export default class AutoLogin extends Component {
    ...
    try {
      ...
      if (value !== null) {
        ...
        if (social == undefined || social.length == 0) {
          this.props.navigation.navigate('RegisterEmail', { is_from_autoLogin: true })
        }
        else {
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: CommonColors.primaryColor }}>

                    ...
                    <View style={{ flex: 1, backgroundColor: CommonColors.primaryColor }}>
                        ...
                        <View style={{ width: '100%', height: '100%', position: 'absolute' }}>
                            ...
                            <ScrollView style={{ height: '100%', width: '100%', }}>
                                ...
                                <Text style={{
                                    marginTop: 20, marginLeft: 20, marginRight: 20, textAlign: 'center', fontSize: SetFontSize.ts30,
                                ...
                                <Text style={{
                                    marginTop: 5, marginLeft: 20, marginRight: 20, textAlign: 'center', fontSize: SetFontSize.ts22,
                                    fontFamily: ConstantKeys.Averta_BOLD, color: CommonColors.whiteColor
                                }}>
                                ...
                                <LinearGradient colors={[CommonColors.gradientStart, CommonColors.gradientEnd]}
                                    ...
                                    style={{
                                        marginTop: 30, marginLeft: 20, marginRight: 20, height: 50,
                                ...
                                <TouchableOpacity style={{ height: 30, marginBottom: 30, marginLeft: 20, marginRight: 20, marginTop: 10, alignItems: 'center', justifyContent: 'center' }}
                                    onPress={() => this.btnSkipTap()}>
                                    <Text style={{ fontFamily: ConstantKeys.Averta_REGULAR, color: CommonColors.whiteColor, fontSize: SetFontSize.ts14 }}>
                                        Skip this step
                                </Text>
                                </TouchableOpacity>

...
import { View, Text, SafeAreaView, StatusBar, TouchableOpacity, StyleSheet, Image, ScrollView, Dimensions,Platform, Keyboard, Alert, PermissionsAndroid } from 'react-native';
...
export default class OTPView extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            longitude: 0.0,
            latitude: 0.0,
            countryCode: props.route.params.country_code,
    ...
    // API LOGIN USER CALL
    API_LOGIN_OTP(isload) {

        this.setState({ isloading: isload })

        Webservice.post(APIURL.loginotp, {
            ...
            .then(response => {
                ...
                this.setState({ isloading: false });
                console.log('Get Login OTP Response : ' + JSON.stringify(response))
                ...
                if (response.data.status == true) {
                    ...
                    // EventRegister.emit('UserCity', userData.CityName)
                    // EventRegister.emit('UserImage', userData.profile_image)
    ...
    storeData = async (value) => {
        try {
            ...
            var social = user.user.social_data
                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={{ width: '100%', height: '100%', position:'absolute' }}>
                        <View style={styles.viewClique}>
                                ...
                                <TouchableOpacity style={{marginLeft:20 , marginTop: 30, height: 40, width: 40, alignItems: 'center', justifyContent: 'center', borderRadius: 20, }}
                        ...
                        <View style={{ flex: 1,}}>
                            ...
                            <ScrollView style={{ flex: 1, }} bounces={false}>
                                ...
                                <OTPInputView
                                    style={{ marginLeft: 20, marginRight: 30, height: 50, marginTop: 30, }}
                                    pinCount={4}
                                ...
                                <Text style={{
                                    ...
                                    color: CommonColors.whiteColor, textAlign: 'center', marginTop: 20
                                }}>
...
const styles = StyleSheet.create({
    ...
    borderStyleHighLighted: {
        ...
        fontFamily: ConstantKeys.Averta_BOLD, color: CommonColors.primaryColor
    },
    btnLogin: {
        marginTop: 30, marginLeft: 20, marginRight: 20, height: 50, backgroundColor: CommonColors.PurpleColor,

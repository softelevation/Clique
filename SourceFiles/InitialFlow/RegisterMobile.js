...
export default class RegisterMobile extends Component {
    ...
    componentDidMount() {
        console.log("Register Data in Register Mobile : " + JSON.stringify(this.state.RegisterData))
    }
        ...
        Webservice.post(APIURL.register, {
            ...
            .then(response => {
                ...
                if (response.data.status == true) {
                    ...
                    this.props.navigation.navigate('RegisterOTPView', { dict: JSON.stringify(dict), otp: OTP })
                    ...
                    <FastImage source={Background}
                        ...
                        <View style={{ width: '100%', height: '100%', position:'absolute' }}>
                            ...
                            <View style={styles.viewClique}>
                                    ...
                                    <TouchableOpacity style={{  marginLeft: 20,marginTop: 20,height: 40, width: 40, alignItems: 'center', 
                            ...
                            <View style={{ flex: 1,}}>
                                ...
                                <ScrollView style={{ width: '100%', }} bounces={false}>
                                    <View style={{ marginTop: 10, marginBottom:20 }}>
                                        ...
                                        <View style={{flexDirection:'row', height:50, marginLeft:20, marginRight:20, marginTop:50, backgroundColor: CommonColors.appBarColor, 
                                                borderRadius : 10}}>
                                            ...
                                            <TextInput
                                                ...
                                                style={{
                                                    flex: 1, height: 50, color: CommonColors.whiteColor, fontSize: SetFontSize.ts14, fontFamily: ConstantKeys.Averta_REGULAR, marginLeft: 5
                                                }}
...
const styles = StyleSheet.create({
    ...
    btnNextDisable: {
        marginBottom: 30, marginLeft: 20, marginRight: 20, height: 50, backgroundColor: CommonColors.SlateBlueColor,
    ...
    viewCountrystyle: {
        ...
        color: CommonColors.MortarColor, fontSize: SetFontSize.ts14, fontFamily: ConstantKeys.Averta_REGULAR
    },
    pickerTitleStyle: {
        justifyContent: 'center',
        flexDirection: 'row',
    ...
    selectedCountryTextStyle: {
        paddingLeft: 5,
        paddingRight: 5,
        color: CommonColors.whiteColor, fontSize: SetFontSize.ts14, fontFamily: ConstantKeys.Averta_REGULAR,
        textAlign: 'center',
    },

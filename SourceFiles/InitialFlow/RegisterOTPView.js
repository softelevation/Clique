...
export default class RegisterOTPView extends Component {
  ...
  API_REGISTER_OTP(isload) {
    ...
    Webservice.post(APIURL.ragisterwithotp, {
      mobile:
        this.state.RegisterData.country_code +
        '-' +
        this.state.RegisterData.mobile_no,
...
const styles = StyleSheet.create({
  ...
  borderStyleBase: {
    ...
    borderRadius: 6,
    fontSize: SetFontSize.ts15,
    fontFamily: ConstantKeys.Averta_BOLD,
    color: CommonColors.whiteColor,,
  },
  borderStyleHighLighted: {
    borderColor: CommonColors.PurpleColor,
    fontSize: SetFontSize.ts15,
    fontFamily: ConstantKeys.Averta_BOLD,

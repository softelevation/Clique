...
import {
    View, Text, SafeAreaView, StyleSheet, StatusBar, Image, TouchableOpacity, ScrollView, TextInput, Keyboard, Platform, Alert, Switch, PermissionsAndroid,
    FlatList, Dimensions
} from 'react-native';
...
export default class RegisterSocialMedia extends Component {
    ...
    getData = async () => {
        try {
            ...
            if (value !== null) {
                ...
                this.setState({ ArrHomeNo: ArrHomeNo, ArrWorkNo: ArrWorkNo, ArrOtherNo: ArrOtherNo })
                //-----------------//
    ...
    createData() {
        ...
        let homeNumberLinks = this.state.ArrHomeNo.filter(el => (
            ...
            return { id, mediaValue: media_value == '' ? "" : country_code + "-" + media_value, status };
        }))
    ...
    API_PROFILE_UPDATE(isload, params) {
        ...
        Webservice.post(APIURL.profileUpdate, {
            ...
            privacy: "0",
            avatar: this.state.RegisterData.imgBase64 == null ? "" : this.state.RegisterData.imgBase64,
            ...
            .then(response => {
                ...
                console.log('Get Profile Update Response : ' + JSON.stringify(response))
                        ...
                        <View style={{ width: '100%', height: '100%', position: 'absolute' }}>
                            ...
                            <ScrollView style={{ height: '100%', width: '100%', }}>
                                ...
                                <View style={styles.viewClique}>
                                    ...
                                    <TouchableOpacity style={{
                                        marginRight: 20, marginTop: 20, height: 40, width: 40, alignItems: 'center', justifyContent: 'center',
                                        borderRadius: 20,
                                    }}>
                                    </TouchableOpacity>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    ...
                                    <View style={{
                                        marginLeft: 20, marginRight: 20, marginTop: 20, height: 50, backgroundColor: CommonColors.appBarColor, flexDirection: 'row',
                                            ...
                                            <FlatList data={this.state.ArrHomeNo}
                                                ...
                                                renderItem={({ item, index }) => (
                                                    ...
                                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, }}>
                                                        ...
                                                        <View style={{
                                                            flex: 1, backgroundColor: CommonColors.appBarColor, borderRadius: 10, alignItems: 'center',
                                                ...
                                                renderItem={({ item, index }) => (
                                                    ...
                                                    <View style={{ flexDirection: 'row', alignItems: 'center', }} >
                                                        ...
                                                        {this.state.ArrWebsite.length != 1 ?
                                                            <TouchableOpacity style={{ width: 30, height: 30, marginLeft: 5, resizeMode: 'contain' }}
                                                                onPress={() => {
                                                ...
                                                renderItem={({ item, index }) => (
                                                    ...
                                                    <View style={{ flexDirection: 'row', alignItems: 'center', }} >
                                                        ...
                                                        <View style={{
                                                            ...
                                                            <Image style={{ height: 30, width: 30, borderRadius: 20, marginLeft: 10, resizeMode: 'center' }}
                                                                source={TwitterIcon} />
                                    ...
                                    <TouchableOpacity style={{
                                        marginLeft: 20, marginRight: 20, marginBottom: 20, flexDirection: 'row', height: 50,
                                        borderRadius: 10, backgroundColor: CommonColors.appBarColor, alignItems: 'center'
                                    }}
                                        onPress={() => {
...
const styles = StyleSheet.create({
    ...
    btnNextDisable: {
        marginBottom: 20, marginLeft: 20, marginRight: 20, height: 50, backgroundColor: CommonColors.SlateBlueColor,
    ...
    btnNextEnable: {
        marginBottom: 20, marginLeft: 20, marginRight: 20, height: 50, backgroundColor: CommonColors.PurpleColor,
        shadowColor: CommonColors.btnShadowColor,
        shadowOffset: { width: 7, height: 5 },
        shadowOpacity: 1, shadowRadius: 5, elevation: 5,
        borderBottomLeftRadius: 20, borderTopRightRadius: 20, alignItems: 'center', justifyContent: 'center'
